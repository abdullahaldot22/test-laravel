                ...
                <table class="table primary-table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#0" title="edit" class="btn btn-primary ed"><i class="fa-regular fa-pen-to-square"></i></a>
                                <a href="#0" title="Delete" class="btn btn-danger ed"><i class="fa-regular fa-trash-can"></i></a>
                            </td>
                        </tr>
                        @empty
                            <tr>
