							...
							<div class="col-lg-12" style="display:flex; flex-flow: row wrap; justify-content:space-around;">
								<div class="col-lg-7 col-md-12">
									...
									<div class="row mb-2">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												<label  title="input with country code & without any special character or space" class="text-dark">Mobile Number *</label>
												<input type="tel" title="input with country code & without any special character or space" name="phone" class="form-control" placeholder="Mobile Number" />
												@error('phone')
													{{ $message }}
												@enderror
											</div>
